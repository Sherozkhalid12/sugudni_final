...
class SellerActiveTabProductProvider extends ChangeNotifier {
  ...
  void fetchActiveProducts(BuildContext context) async {
    ...
    try {
      var response = await SellerProductRepository.allSellerProductsUsingPagination(context, ProductStatus.active,currentPage);
