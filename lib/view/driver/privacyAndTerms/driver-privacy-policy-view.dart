...
class DriverPrivacyPolicyView extends StatelessWidget {
  const DriverPrivacyPolicyView({super.key});
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Center(child: MyText(text: AppLocalizations.of(context)!.privacypolicy,size: 22.sp,fontWeight: FontWeight.w600,)),
                  10.height,
                  Container(
