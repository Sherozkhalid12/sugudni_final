...
class DriverCompletedShipmentView extends StatelessWidget {
  const DriverCompletedShipmentView({super.key});
              ...
              children: [
                ...
                FutureBuilder(
                    ...
                    builder: (context,snapshot){
                      ...
                      var filteredOrders = data!.where((order) => order.isDelivered==true).toList();
