...
${AppLocalizations.of(context)!.beforeyoumakepayment}''',size: 11.sp,),
            ...
            Row(
              children: [
                ...
                const Spacer(),
                FindCurrency(
                  usdAmount: calculateCorrectCartPrice(
                    cartProvider.cartResponse!.cart.totalPrice,
                    cartProvider.cartResponse!.cart.totalPriceAfterDiscount,
                    cartProvider.cartResponse!.cart.discount,
                  ),
                  size: 12.sp,
