...
class CustomerAllProductsByCategoryView extends StatefulWidget {
  const CustomerAllProductsByCategoryView({super.key});

  @override
  State<CustomerAllProductsByCategoryView> createState() => _CustomerAllProductsByCategoryViewState();
}

class _CustomerAllProductsByCategoryViewState extends State<CustomerAllProductsByCategoryView> {
  String query='';
  late CustomerFetchProductByCategoryProvider productProvider;
  final ScrollController _scrollController = ScrollController();

  @override
  void initState() {
    super.initState();
    productProvider = Provider.of<CustomerFetchProductByCategoryProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    final customerProductProvider=Provider.of<CustomerFetchProductByCategoryProvider>(context,listen: false);
    ...
    return PopScope(
       onPopInvokedWithResult: (didPop, result) {
        ...
        customerProductProvider.resetFilter();
       },
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Row(
            children: [
              ...
              Flexible(
                flex: 9,
                child: TextFormField(
                  controller: customerProductProvider.searchController,
                  style: TextStyle(
                  ...
                  onChanged: (v){
                    ...
                    // customerProductProvider.changeQuery(v);
                  },
                  decoration: InputDecoration(
                    prefixIcon: const Icon(Icons.search,color: Color(0xff545454),),
                    hintText: AppLocalizations.of(context)!.searchproductincategory,
                    hintStyle: TextStyle(
                        fontWeight: FontWeight.w500,
                        fontSize: 10.sp,
                        color: const Color(0xff545454)
                    ...
                    suffixIcon: GestureDetector(
                      onTap: (){
                        customerProductProvider.changeQuery(productProvider.searchController.text.trim());
        ...
        body: Stack(
          children: [
            Consumer<CustomerFetchProductByCategoryProvider>(builder: (context,provider,child){
                            ...
                            Container(
                              ...
                              decoration:  BoxDecoration(
                                  image: DecorationImage(image: NetworkImage(
                                    d.bulk==true? d.imgCover:"${ApiEndpoints.productUrl}/${d.imgCover}"),fit: BoxFit.contain)
                              ),
                              child: Column(
  ...
  showDialog(
    ...
    builder: (context) {
      return AlertDialog(
        ...
        content: Consumer<CustomerFetchProductByCategoryProvider>(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              filterProvider.filterProducts(filterProvider.minPrice, filterProvider.maxPrice,minRating: filterProvider.minRating,maxRating: filterProvider.maxPrice);
              Navigator.pop(context);
            },
