...
import '../../../utils/product-status.dart';
import '../../currency/find-currency.dart';

class ShopNowStylishGridForProductDetail extends StatelessWidget {
  const ShopNowStylishGridForProductDetail({super.key});
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: MyText(text: "Shop Now",color: primaryColor,size: 9.sp,fontWeight: FontWeight.w600),
                          ),
                        ),
                      )
                    ],
