...
class SellerFailedOrderTab extends StatelessWidget {
  const SellerFailedOrderTab({super.key});
        ...
        builder: (context,snapshot){
          ...
          if (data == null || data.orders == null) {
            return EmptyStateWidget(
              ...
              description: 'Great news! You don\'t have any failed orders. All your orders are processing successfully.',
              icon: Icons.error_outline,
            );
          }
          var filteredOrders = data.orders!.where((order) => order.cartItem.isNotEmpty).toList();
          var toShipOrders = filteredOrders.where((order) => order.trackingStatus==DeliveryStatus.failed).toList();
