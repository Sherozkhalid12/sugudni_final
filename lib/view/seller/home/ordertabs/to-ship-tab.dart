...
class SellerToShipOrderTab extends StatelessWidget {
  const SellerToShipOrderTab({super.key});
        ...
        builder: (context,snapshot){
          ...
          if (data == null || data.orders == null) {
            return EmptyStateWidget(
              ...
              description: 'You don\'t have any orders ready to ship at the moment. Orders will appear here once they\'re ready for shipping.',
              icon: Icons.local_shipping_outlined,
            );
          }
          var filteredOrders = data.orders!.where((order) => order.cartItem.isNotEmpty).toList();
          var toShipOrders = filteredOrders.where((order) => order.trackingStatus==DeliveryStatus.toShip).toList();
          ...
          return Expanded(
              child: ListView.builder(
                  itemCount: toShipOrders.length,
                  itemBuilder: (context, index) {
                    var orderData=toShipOrders[index];
                    return Container(
                      //  height: 162.h,
                              ...
                              children: [
                                ...
                                Flexible(
                                    ...
                                    child: RoundButton(
                                        ...
                                        onTap: () {
                                          Navigator.push(context, MaterialPageRoute(builder: (context)=>SellerOrderDetailView(orderSellerResponse: toShipOrders[index])));
                                        })),
                              ],
                            )
                          ],
