...
class SellerSupportChatView extends StatefulWidget {
  const SellerSupportChatView({super.key});

  @override
  State<SellerSupportChatView> createState() => _SellerSupportChatViewState();
}

class _SellerSupportChatViewState extends State<SellerSupportChatView> {
